...
class OrderAdmin(admin.ModelAdmin):
    list_display = ("user", "store", "order_id", "customer_name", "status", "created_at", "updated_at", "total", "total_bch", "payment_method", "total_received")
...
class TotalSalesAdmin(admin.ModelAdmin):
    list_display = ("user", "total_sale")
    list_filter = ("user", "total_sale")
...
class TotalSalesByYearAdmin(admin.ModelAdmin):
    list_display = ("user", "year", "total_sale")
    list_filter = ("user", "year", "total_sale")
